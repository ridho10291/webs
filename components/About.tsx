      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-2">
          ...
          >
            {highlights.map((h, i) => (
              <motion.article
                key={h.title}
                className="group relative overflow-hidden rounded-2xl border border-border/50 bg-bg-elevated/50 p-6 transition-all duration-500 hover:border-primary/50 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] hover:shadow-primary/10"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        >
          {stack.map((s, i) => (
            <motion.article
              key={s.name}
              className="group relative rounded-2xl border border-border/50 bg-bg-elevated/50 p-6 transition-all duration-500 hover:border-primary/50 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] hover:shadow-primary/10"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
